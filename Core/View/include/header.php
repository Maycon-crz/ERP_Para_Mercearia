...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container-fluid">
			<a class="navbar-brand text-success" href="#">ERP Mercearia</a>
			...
			<div class="collapse navbar-collapse justify-content-end" id="navbarNav">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">			    
					...
					<li class="nav-item text-center btn btn-outline-success rounded m-3">
					  <a class="nav-link" href="#">Cadastro de Fornecedores</a>
					</li>
					<li class="nav-item text-center btn btn-outline-danger rounded m-3">
					  <a class="nav-link" href="#">Sair</a>
					</li>
					<li class="nav-item text-center btn rounded m-3">
						<a id='navOpcoesLogado' class='form-control text-center dropdown-toggle' role='button' data-bs-toggle='dropdown' aria-expanded='false'>EDIÇÃO</a>
						<ul class='dropdown-menu form-control text-center' aria-labelledby='navOpcoesLogado'>
							<li class='dropdown-item border p-0 mt-2'>      
								<a class="nav-link btn btn-outline-success" href="#">Edição de Produtos</a>
							</li> 
							<li class='dropdown-item border p-0 mt-2'>      
